 ...
 * It creates and hosts the texture given to ARCore to be filled with the camera image.
 */
public class BackgroundRenderer {
   ...
   * Parameter context Needed to access shader source.
   */
   ...
   * the matrices provided by { com.google.ar.core.Camera #getViewMatrix(float[], int)}
   * { com.google.ar.core.Camera #getProjectionMatrix(float[], int, float, float)} will
   * accurately follow static physical objects. This must be called <b>before</b> drawing virtual content.
   */
   ...
   * The image will be center cropped if the camera sensor aspect ratio does not match the screen aspect ratio.
   */
  public void draw(
