...
public class ShaderUtil {
   ...
   * parameter type The type of shader we will be creating.
   * parameter filename The filename of the asset file about to be turned into a shader.
   ...
   * parameter {label} Label to report in case of error.
   ...
   * parameter {filename} The filename of the shader file about to be turned into a shader.
