...
public class PointCloudRenderer {
   ...
   * parameter {cameraView} the camera view matrix for this frame, typically from
   * {com.google.ar.core.Camera#getViewMatrix(float[], int)}.
   * parameter {cameraPerspective} the camera projection matrix for this frame, typically from
