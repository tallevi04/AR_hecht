...
public class PlaneRenderer {
   ...
   * parameter {context} Needed to access shader source and texture PNG.
   * parameter {gridDistanceTextureName} Name of the PNG file containing the grid texture.
   */
  ...
  private void updatePlaneParameters(
    ...
    */
    ...
    // when either dimension of the bounding box is smaller than 2*FADE_RADIUS_M we
    // generate a bunch of 0-area triangles.
