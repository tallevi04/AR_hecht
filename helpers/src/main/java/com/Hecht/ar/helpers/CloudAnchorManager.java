...
/**
 * A helper class to handle all the Cloud Anchors logic, and add a callback-like mechanism on top of the existing ARCore API.
 */
public class CloudAnchorManager {
  ...
  /**
   * This method hosts an anchor. The listener will be invoked when the results are available.
   */
  ...
  /**
   * This method resolves an anchor. The listener will be invoked when the results are available.
   */
