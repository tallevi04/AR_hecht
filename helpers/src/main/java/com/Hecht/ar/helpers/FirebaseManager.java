...
public class FirebaseManager {
  ...
  private static final String KEY_ROOT_DIR = "shared_cloud_anchors";
  ...
  /**
   * Retrieves the cloud anchor ID using a short code. Returns an empty string if a cloud anchor ID was not stored for this short code.
   */
