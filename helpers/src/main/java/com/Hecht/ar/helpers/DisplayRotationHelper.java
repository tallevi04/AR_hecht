 ...
 * by the onSurfaceChanged() callback, and thus they require listening to the android display events.
 */
public final class DisplayRotationHelper implements DisplayListener {
   ...
   * #updateSessionIfNeeded(Session)}. Should be called from android.opengl.GLSurfaceView.Renderer
